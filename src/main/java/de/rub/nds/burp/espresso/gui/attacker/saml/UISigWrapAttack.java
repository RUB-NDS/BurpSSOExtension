...
public class UISigWrapAttack extends javax.swing.JPanel implements IAttack {
    ...
    private void initComponents() {
        ...
        payloadComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                payloadComboBoxActionPerformed(evt);
            }
        });
        ...
        updateButton.setText("Update Oracle");
    ...
    private void attackSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_attackSliderStateChanged
        ...
        private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
            notifyAllTabs(code);
            Logging.getInstance().log(getClass().getName(), "SAML successfully updated!", false);
        ...
        private void payloadComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_payloadComboBoxItemStateChanged
            ...
            payload = p;
            Logging.getInstance().log(getClass().getName(), "Select Payload No. "+(selected+1), false);
        ...
        private void payloadValueKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_payloadValueKeyReleased
            payload.setValue(payloadValue.getText());
            Logging.getInstance().log(getClass().getName(), "Updating Payload Value.", false);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        Logging.getInstance().log(getClass().getName(), "Updating Signature Oracle.", false);
    }//GEN-LAST:event_updateButtonActionPerformed

    private void payloadComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_payloadComboBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_payloadComboBoxActionPerformed
    ...
    private void attackNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attackNumberActionPerformed
        ...
        attackSlider.setValue(new Integer(attack));
    }//GEN-LAST:event_attackNumberActionPerformed

    private void attackSliderMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_attackSliderMouseReleased
        int attack = attackSlider.getValue();
        
        //Update the Attack Number
        attackNumber.setText((new Integer(attack)).toString());
        Logging.getInstance().log(getClass().getName(), "Slider Changed to "+attack, false);
    }//GEN-LAST:event_attackSliderMouseReleased
